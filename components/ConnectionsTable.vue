<template>
  <div class="bg-white dark:bg-slate-700 rounded-lg shadow-md overflow-hidden flex flex-col h-full">
    <!-- Table Header - Fixed -->
    <div class="px-6 py-4 bg-gray-50 dark:bg-slate-600 border-b border-gray-200 dark:border-slate-500 flex-shrink-0">
      ...
      <div class="overflow-auto h-full">
        ...
        <thead class="table-header">
          <tr>
            ...
            <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider">Local Address</th>
            <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider">Local Port</th>
            <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider">Remote Address</th>
            <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider">Remote Port</th>
        ...
        <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
          ...
          <tr v-for="n in 8" :key="n" class="animate-pulse">
            ...
            <td class="px-6 py-4 whitespace-nowrap">
              <div class="h-6 bg-gray-200 dark:bg-gray-600 rounded-full w-20"></div>
            </td>
            <td class="px-6 py-4 whitespace-nowrap">
              <div class="h-4 bg-gray-200 dark:bg-gray-600 rounded w-12"></div>
            </td>
    ...
    <div v-else-if="error" class="flex-1 flex items-center justify-center px-6 py-12">
      ...
      <h3 class="text-lg font-semibold text-gray-900 dark:text-white mb-2">Error Loading Connections</h3>
    ...
    <div v-else-if="filteredConnections.length === 0" class="flex-1 flex items-center justify-center px-6 py-12">
      ...
      <h3 class="text-lg font-semibold text-gray-900 dark:text-white mb-2">No Connections Found</h3>
